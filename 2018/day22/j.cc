...
struct abprimes
{
    ...
    abprimes(void)
    {
        primes.pb(100001449);
        primes.pb(99999989);
        primes.pb(1000000007);
        primes.pb(1000000009);
        primes.pb(1000000021); // 5
        primes.pb(998000027);
        primes.pb(998244353);
        primes.pb(100000493);
        primes.pb(99994253);
        primes.pb(100000561); // 10
        primes.pb(100000037);
        primes.pb(99999959);
        primes.pb(100000463);
        primes.pb(99999773);
        primes.pb(1500000001); // 15
    }
}primes;
...
class ac_machine
{
    ...
    bool check(ll p)
    {
        ...
        for(int i = 0;i < len;i++)
        {
            nrem = (nrem * 10ll + n[i] - '0') % p;
        }
        ll r = qow(nrem, (p - 1ll)/2ll, p);
        return (1 == r);
    }
public:
    int wa(void)
    {
        ...
        io << (ok >= threshold ? "Yes" : "No") << io.endl;
        return 0;
    }
};
